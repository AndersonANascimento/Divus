...
/**
 * TesteCastTiposPrimitivos - AJ1 - Código 12 - Página 72
 */
public class TesteCastTiposPrimitivos {
    public static void main(String[] args) {
        ...
        // cast de int para char (int é maior que char -> cast explicíto)
        ...
        // cast de char para byte (byte é menor que char -> cast explicíto)
        ...
        // cast de float para int (float é maior que int -> cast explicíto)
        int i = (int) 5658.0f;
