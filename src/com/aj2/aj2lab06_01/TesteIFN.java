...
public class TesteIFN {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("IFN devido por conta1: R$" + conta1.getIFNAcumulado());
        System.out.println("IFN devido por conta2: R$" + conta2.getIFNAcumulado());
